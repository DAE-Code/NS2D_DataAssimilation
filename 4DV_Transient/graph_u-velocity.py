...
plt.legend()
plt.savefig('4DVar_Transient_'+sys.argv[1]+'.png',dpi=300)
print('--> 4DVar_Transient_'+sys.argv[1]+'.png')
...
plt.legend()
plt.savefig('4DVar_Transient_'+sys.argv[1]+'_RMSE.png',dpi=300)
print('--> 4DVar_Transient_'+sys.argv[1]+'_RMSE.png')  
